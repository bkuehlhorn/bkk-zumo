...
# logging = fsm_logging()
checkEvents = zevents.CheckEvents(eventList, timer_action_event, display)
# FSM => matrix[state, event] of nextState
stateActions = zactions.StateAction(actionMatrix, display)
